...
class DynamicTimer {
  ...
  DynamicTimer.periodic(Duration duration, this._callback)
...
extension EdgeInsetsUtils on EdgeInsets {
  EdgeInsetsDirectional directional() => this is EdgeInsetsDirectional
      ? this as EdgeInsetsDirectional
      : EdgeInsetsDirectional.fromSTEB(left, top, right, bottom);
}
